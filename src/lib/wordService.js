  ...
  loadWordsForDifficulty(difficulty) {
    ...
    const wordDatabase = {
      ...
      medium: [
        ...
        'remember', 'remove', 'repeat', 'replace', 'reply', 'report', 'represent', 'Republican', 'require', 'research', 'resource', 'respond',
        'response', 'responsibility', 'rest', 'result', 'return', 'reveal', 'rich', 'right', 'rise', 'risk', 'road', 'rock', 'role',
        'room', 'rule', 'run', 'safe', 'same', 'save', 'say', 'scene', 'school', 'science', 'scientist', 'score', 'sea', 'season',
        'seat', 'second', 'section', 'security', 'see', 'seek', 'seem', 'sell', 'send', 'senior', 'sense', 'series', 'serious', 'serve',
        'service', 'set', 'seven', 'several', 'sex', 'sexual', 'shake', 'share', 'she', 'shoot', 'short', 'shot', 'should', 'shoulder',
        'show', 'side', 'sign', 'significant', 'similar', 'simple', 'simply', 'since', 'sing', 'single', 'sister', 'sit', 'site', 'situation',
        'six', 'size', 'skill', 'skin', 'sky', 'sleep', 'slide', 'slight', 'slip', 'slow', 'small', 'smile', 'smoke', 'smooth', 'snap',
        'snow', 'so', 'soccer', 'social', 'society', 'soft', 'soldier', 'solid', 'some', 'somebody', 'someone', 'something', 'sometimes',
        'son', 'song', 'soon', 'sort', 'soul', 'sound', 'soup', 'south', 'space', 'speak', 'special', 'specific', 'speech', 'speed',
        'spend', 'sport', 'spot', 'spread', 'spring', 'square', 'staff', 'stage', 'stand', 'standard', 'star', 'start', 'state', 'statement',
        'station', 'stay', 'steal', 'step', 'stick', 'still', 'stock', 'stomach', 'stone', 'stop', 'store', 'storm', 'story', 'straight',
        'strange', 'strategy', 'street', 'strong', 'structure', 'student', 'study', 'stuff', 'stupid', 'style', 'subject', 'submit',
        'subsequent', 'succeed', 'success', 'successful', 'such', 'suddenly', 'suffer', 'suggest', 'summer', 'sun', 'super', 'supply',
        'support', 'sure', 'surface', 'surgery', 'surprise', 'surround', 'survey', 'survive', 'suspect', 'sustain', 'swear', 'sweep',
        'sweet', 'swim', 'swing', 'switch', 'symbol', 'symptom', 'system', 'table', 'tablespoon', 'tackle', 'tail', 'take', 'talk',
        'tall', 'tank', 'tap', 'tape', 'target', 'task', 'taste', 'tax', 'tea', 'teach', 'teacher', 'team', 'tear', 'teaspoon', 'teeth',
        'telephone', 'television', 'tell', 'temperature', 'ten', 'tend', 'tent', 'term', 'test', 'text', 'than', 'thank', 'thanks',
        'that', 'the', 'their', 'them', 'themselves', 'then', 'theory', 'therapy', 'there', 'therefore', 'these', 'they', 'thick',
        'thin', 'thing', 'think', 'third', 'thirty', 'this', 'those', 'though', 'thought', 'thousand', 'threat', 'three', 'through',
        'throughout', 'throw', 'thus', 'ticket', 'tie', 'tight', 'time', 'tiny', 'tip', 'tire', 'tired', 'tissue', 'title', 'to',
        'tobacco', 'today', 'toe', 'together', 'toilet', 'tomorrow', 'tone', 'tongue', 'tonight', 'too', 'tool', 'tooth', 'top', 'topic',
        'total', 'touch', 'tough', 'tour', 'toward', 'towards', 'tower', 'town', 'toy', 'track', 'trade', 'tradition', 'traffic',
        'tragedy', 'trail', 'train', 'training', 'transfer', 'transform', 'transition', 'translate', 'transport', 'trap', 'trash',
        'travel', 'treat', 'treatment', 'tree', 'tremendous', 'trend', 'trial', 'tribe', 'trick', 'trip', 'troop', 'trouble', 'truck',
        'true', 'truly', 'trust', 'truth', 'try', 'tube', 'tune', 'turn', 'twelve', 'twenty', 'twice', 'twin', 'two', 'type', 'typical',
        'ugly', 'ultimate', 'unable', 'uncle', 'under', 'undergo', 'understand', 'undertake', 'unemployment', 'unexpected', 'unfortunately',
        'uniform', 'union', 'unique', 'unit', 'united', 'universe', 'university', 'unknown', 'unless', 'unlike', 'unlikely', 'until',
        'unusual', 'up', 'upon', 'upper', 'urban', 'urge', 'us', 'use', 'used', 'useful', 'user', 'usual', 'usually', 'utility', 'vacation',
        'valley', 'valuable', 'value', 'variable', 'variation', 'variety', 'various', 'vast', 'vegetable', 'vehicle', 'venture', 'version',
        'versus', 'very', 'vessel', 'veteran', 'via', 'victim', 'victory', 'video', 'view', 'village', 'violence', 'violent', 'virtual',
        'virus', 'visible', 'vision', 'visit', 'visitor', 'visual', 'vital', 'voice', 'volume', 'volunteer', 'vote', 'voter', 'vs',
        'vulnerable', 'wage', 'wait', 'wake', 'walk', 'wall', 'want', 'war', 'warm', 'warn', 'wash', 'waste', 'watch', 'water',
        'wave', 'way', 'we', 'weak', 'wealth', 'wealthy', 'weapon', 'wear', 'weather', 'web', 'website', 'wedding', 'week', 'weekend',
        'weekly', 'weigh', 'weight', 'welcome', 'welfare', 'well', 'west', 'western', 'wet', 'what', 'whatever', 'wheel', 'when',
        'whenever', 'where', 'whereas', 'wherever', 'whether', 'which', 'while', 'whisper', 'white', 'who', 'whole', 'whom', 'whose',
        'why', 'wide', 'widely', 'wife', 'wild', 'will', 'willing', 'win', 'wind', 'window', 'wine', 'wing', 'winner', 'winter', 'wipe',
        'wire', 'wise', 'wish', 'with', 'within', 'without', 'witness', 'woman', 'wonder', 'wonderful', 'wood', 'wooden', 'wool',
        'word', 'work', 'worker', 'working', 'workplace', 'workshop', 'world', 'worried', 'worry', 'worse', 'worst', 'worth', 'would',
        'wrap', 'write', 'writer', 'writing', 'written', 'wrong', 'yard', 'yeah', 'year', 'yellow', 'yes', 'yesterday', 'yet', 'you',
      ...
      hard: [
        ...
        'computational', 'mathematical', 'numerical', 'algorithmic', 'computational', 'technological', 'methodological',
        'philosophical', 'psychological', 'sociological', 'anthropological', 'archaeological', 'astronomical', 'geological',
        'biological', 'chemical', 'physical', 'mathematical', 'statistical', 'analytical', 'theoretical', 'practical',
        'therapeutic', 'diagnostic', 'prognostic', 'symptomatic', 'systematic', 'automatic', 'democratic', 'republican',
        'authoritarian', 'totalitarian', 'bureaucratic', 'aristocratic', 'demographic', 'geographic', 'photographic',
        'cinematographic', 'stereographic', 'holographic', 'calligraphic', 'typographic', 'orthographic', 'lexicographic',
        'bibliographic', 'biographic', 'autobiographic', 'historiographic', 'cartographic', 'oceanographic', 'meteorological',
        'climatological', 'ecological', 'environmental', 'experimental', 'developmental', 'instructional', 'educational',
        'vocational', 'professional', 'occupational', 'recreational', 'therapeutic', 'diagnostic', 'prognostic', 'symptomatic',
        'systematic', 'automatic', 'mechanistic', 'deterministic', 'stochastic', 'probabilistic', 'statistical', 'analytical',
        'theoretical', 'empirical', 'experimental', 'observational', 'computational', 'mathematical', 'numerical', 'algorithmic'
      ]
    };
